...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            Log.d(Constants.TAG, "Without saved Instance");
        } else {
            Log.d(Constants.TAG, "With saved Instance");
            ...
            if (savedInstanceState.containsKey(Constants.USERNAME_TAG)) {
                ...
                editTextUsername.setText(savedInstanceState.getString(Constants.USERNAME_TAG));
            }

            if (savedInstanceState.containsKey(Constants.PASSWORD_TAG)) {
                EditText editTextPassword = (EditText) findViewById(R.id.password_edit_text);
                editTextPassword.setText(savedInstanceState.getString(Constants.PASSWORD_TAG));
            }
        }
    ...
    public void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        if (checkBox.isChecked()) {
            savedInstanceState.putString(Constants.USERNAME_TAG, editTextUsername.getText().toString());
            savedInstanceState.putString(Constants.PASSWORD_TAG, editTextPassword.getText().toString());
